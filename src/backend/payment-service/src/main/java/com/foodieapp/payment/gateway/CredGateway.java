...
@Component
@Slf4j
public class CredGateway {

    public Map<String, Object> initiatePayment(Long orderId, BigDecimal amount, String reference) {
        log.info("CredGateway: Initiating payment for order {} amount {}", orderId, amount);
        return Map.of(
            "gateway", "CredGateway",
    ...
    public Map<String, Object> verifyPayment(String transactionId) {
        log.info("CredGateway: Verifying payment {}", transactionId);
    ...
    public Map<String, Object> refundPayment(String transactionId, BigDecimal amount) {
        log.info("CredGateway: Refunding {} for transaction {}", amount, transactionId);
