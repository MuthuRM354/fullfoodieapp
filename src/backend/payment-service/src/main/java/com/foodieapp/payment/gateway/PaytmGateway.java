...
public class PaytmGateway {
    ...
    public Map<String, Object> initiatePayment(Long orderId, BigDecimal amount, String reference) {
        log.info("PaytmGateway: Initiating payment for order {} amount {}", orderId, amount);
        return Map.of(
    ...
    public Map<String, Object> verifyPayment(String transactionId) {
        log.info("PaytmGateway: Verifying payment {}", transactionId);
    ...
    public Map<String, Object> refundPayment(String transactionId, BigDecimal amount) {
        log.info("PaytmGateway: Refunding {} for transaction {}", amount, transactionId);
