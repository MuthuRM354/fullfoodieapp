package com.foodieapp.notification.security;
 ...
 * order-service posting a notification after placing an order). The
 * internal key grants a synthetic ROLE_SERVICE principal.
 */
@Component
