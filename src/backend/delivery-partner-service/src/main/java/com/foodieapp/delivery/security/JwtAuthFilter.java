package com.foodieapp.delivery.security;
 ...
 * order-service auto-assigning a delivery partner when an order is ready
 * for pickup). The internal key grants a synthetic ROLE_SERVICE principal.
 */
@Component
