...
public class AdminService {
    ...
    public Admin create(Admin admin) {
        if (repo.existsByEmail(admin.getEmail())) throw new RuntimeException("Admin already exists: " + admin.getEmail());
        return repo.save(admin);
    }
    public Admin getById(Long id) { return repo.findById(id).orElseThrow(() -> new RuntimeException("Admin not found: " + id)); }
    ...
    public Admin deactivate(Long id) { Admin a = getById(id); a.setActive(false); return repo.save(a); }
}
